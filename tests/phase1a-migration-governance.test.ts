...
// 🚨 BUMPING THIS DOES NOT MAKE A MIGRATION RUNNABLE. It only records how many
// .sql files exist. Registration is five separate sites (REGISTRY_DEPLOYMENT,
// REGISTRY_SEQUENCE, TARGETED_RECOVERY_ALLOWLIST, the API action list, the
// console button) — 121 was bumped here and registered at NONE of them, which
