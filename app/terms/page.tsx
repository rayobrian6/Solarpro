  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      {required && status === 'pending' && (
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl px-5 py-3 mb-8 flex items-center gap-3">
      ...
      <div className="bg-slate-900/60 border border-slate-700/50 rounded-2xl overflow-hidden mb-8">
        <div className="p-8 space-y-8 text-sm text-slate-300 leading-relaxed max-h-[70vh] overflow-y-auto">
...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <Suspense fallback={
        <div className="max-w-4xl mx-auto px-6 py-12 text-slate-400 text-sm">
          Loading agreement…
        </div>
      }>
        <TermsContent />
