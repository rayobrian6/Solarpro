...
// ── PageShell — MUST be outside ResetPasswordForm to prevent remount on every render ──
// ⚠️  DO NOT move this inside ResetPasswordForm. Defining a component inside another
//    component causes React to treat it as a new component type on every render,
//    which unmounts and remounts the entire subtree (including inputs), causing
//    focus to be lost after every keystroke.
