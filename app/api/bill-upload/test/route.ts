...
try {
  ...
  pdfParseError = e instanceof Error ? (e as Error).message : String(e);
}
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    debug.steps.push({ method: 'pdf-parse', error: e instanceof Error ? (e as Error).message : String(e), success: false });
  }
  ...
  try {
    ...
    debug.steps.push({ method: 'raw-text-extract', error: e instanceof Error ? (e as Error).message : String(e), success: false });
  }
  ...
  if (openaiKey) {
    ...
    try {
      ...
      debug.steps.push({ method: 'openai-upload-user_data', error: e instanceof Error ? (e as Error).message : String(e), success: false });
    }
    ...
    if (uploadedFileId) {
      try {
        ...
        debug.steps.push({ method: 'openai-responses-api', error: e instanceof Error ? (e as Error).message : String(e), success: false });
      }
    ...
    try {
      ...
      debug.steps.push({ method: 'gpt4o-text-hint', error: e instanceof Error ? (e as Error).message : String(e), success: false });
    }
  } else {
