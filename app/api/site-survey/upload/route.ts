...
export async function GET(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      normalized: JSON.parse(String(row.normalized)),
      enriched: JSON.parse(String(row.enriched)),
      structuralFeasibility: JSON.parse(String(row.structural_feasibility)),
      electricalFeasibility: JSON.parse(String(row.electrical_feasibility)),
