...
const ARCHITECTURE_NODES: ArchitectureNode[] = [
  ...
  { id: 'engineering', group: 'Engineering & Documents', title: 'Engineering, SLD, BOM, Permit Package', detail: 'Engineering APIs calculate topology, BOM, SLD/PDF, PVWatts, and the canonical permit/planset package (via /api/engineering/permit → PermitDesignSnapshot). The legacy /api/engineering/plan-set generator was retired in W4 §6 (single planset authority).', evidence: ['/engineering', '/api/engineering/topology', '/api/engineering/bom', '/api/engineering/sld', '/api/engineering/permit', '/api/engineering/pvwatts'], tables: ['engineering_runs', 'project_hardware', 'project_files', 'productions'], status: 'live', layer: 'engineering' },
