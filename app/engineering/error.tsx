...
export default function EngineeringError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div style={{
      ...
      <p style={{ color: '#94a3b8', fontSize: 14, marginBottom: 24, textAlign: 'center', maxWidth: 400 }}>
        {error.message || 'The engineering module encountered an error. Your project data is safe.'}
      </p>
