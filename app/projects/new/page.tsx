  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.update(toastId, {
        ...
        message: (e as Error)?.message || 'Please try again. If the problem persists, refresh the page.',
      });
    } finally {
      setSaving(false);
    }
          ...
          <div className="card p-5">
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="font-semibold text-white text-sm">Upload Electric Bill <span className="text-xs font-medium text-amber-400 ml-1">Recommended</span></h2>
