...
// This file provides solar production calculations and quick savings estimates.
// annualSavings = production * rate here is an UPSTREAM ESTIMATE for project creation.
// It is NOT part of the canonical proposal pipeline.
// Canonical savings derive from:
//   computeEnergyFlow() → computeEnergyValue() → calculate25yrProjection()
// DO NOT use pvwatts.ts savings/payback outputs in proposal view.
// ─────────────────────────────────────────────────────────────────────────────
// ============================================================
