...
const GENERAL_NOTES = [
  ...
  `This plan set was generated by SolarPro Engineering Engine ${BUILD_VERSION}. A licensed professional engineer stamp is required for permit submission where required by the AHJ.`,
];