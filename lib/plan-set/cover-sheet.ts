...
// Plan Set Sheet G-1: Cover Sheet
// Includes: project summary, AHJ info, code compliance table,
// scope of work, general notes, sheet index
// ============================================================
  ...
  const content = `
    ...
    <div class="two-col" style="gap:12px; margin-top:6px;">
      ...
      <div>
        ...
        <table>
          <tr><td style="width:38%;color:#555;">Client Name</td><td><strong>${escHtml(inp.clientName)}</strong></td></tr>
        ...
        <table>
          <tr><td style="width:38%;color:#555;">System Size (DC)</td><td><strong>${inp.systemKw.toFixed(2)} kW</strong></td></tr>
          <tr><td style="color:#555;">Panel Count</td><td>${inp.panelCount} panels</td></tr>
          <tr><td style="color:#555;">Panel Model</td><td>${escHtml(inp.panelModel)} (${inp.panelWatts}W)</td></tr>
        ...
        <table>
          <tr><td style="width:38%;color:#555;">Contractor</td><td>${escHtml(inp.contractorName)}</td></tr>
          ${inp.contractorLicense ? `<tr><td style="color:#555;">License #</td><td>${escHtml(inp.contractorLicense)}</td></tr>` : ''}
          ...
          <tr><td style="color:#555;">Prepared By</td><td>SolarPro Engineering Engine v43.0</td></tr>
        </table>
      ...
      <div>
        ...
        <table>
          ...
          ${inp.windSpeedMph ? `<tr><td style="color:#555;">Design Wind Speed</td><td>${inp.windSpeedMph} mph (3-sec gust)</td></tr>` : ''}
        ...
        <div style="font-size:7pt; line-height:1.6; padding: 4px 6px; background:#f7f8fc; border:0.5px solid #ccd; border-radius:2px;">
          ...
          <strong>${inp.panelCount} × ${inp.panelWatts}W solar panels</strong>
...
const GENERAL_NOTES = [
  ...
  'All conductors shall be copper unless otherwise noted. Minimum conductor temperature rating: 90°C (THWN-2 or USE-2).',
  'All conduit shall be Schedule 40 PVC or EMT unless otherwise noted. Conduit fill shall not exceed NEC Chapter 9 limits.',
  'Grounding and bonding shall comply with NEC Article 250 and NEC 690.47.',
  'Rapid shutdown system shall comply with NEC 690.12. Initiation device shall be located at the utility meter or as required by AHJ.',
  'Roof penetrations shall be flashed and sealed per manufacturer requirements and local building code.',
