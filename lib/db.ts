...
export const defaultPanels: SolarPanel[] = [
  // ── Standard 440W (default) ──
  // Jinko JKM440N-54HL4R-V: 44.49" x 69.29" = 1.130m x 1.760m
  // Width 1.130m = 3.708ft (44.5"), Height 1.762m = 5.781ft (69.4")
  // Industry-standard residential 440W footprint used as the default.
  {
    id: 'panel-std440', manufacturer: 'Jinko Solar', model: 'Eagle Neo N-type 440W',
    wattage: 440, width: 1.130, height: 1.762, efficiency: 22.0,
  ...
  // PRIMARY: Philadelphia Solar Nexus — the standard Sol Fence panel (v47.239)
  // Datasheet: PS-MNB108(HCBF)-440W | Half-Cell N-Type 16BB Bifacial
  // Dims: 1721mm × 1133mm × 30mm | Weight: 20.5kg | Degradation: -0.4%/yr
  // Certifications: UL 61215/61730, IEC 61215/61730, CSA C22.2#61730:2019
  // CROSS-REF: Also defined in equipment-registry-v4.ts (V4 BOM lookup) and
  //            systemEquipmentResolver.ts resolveDefaultFencePanelSpec() (structural specs).
  //            db.ts = UI/DB seed, registry = BOM engine, resolver = structural profile.
  {
    id: 'panel-fence-ps1',
    manufacturer: 'Philadelphia Solar',
    model: 'Nexus PS-MNB108(HCBF)-440W',
    wattage: 440,
    width: 1.133,   // 1133mm (horizontal dimension when mounted vertically on fence)
    height: 1.721,  // 1721mm (vertical dimension)
    efficiency: 22.57,
    bifacial: true,
    bifacialFactor: 1.20,  // 80% bifaciality ratio ±5% → conservative 20% rear gain
    temperatureCoeff: -0.30,  // Pmax temp coefficient %/°C
    pricePerWatt: 0.31,
    warranty: 30,   // 30-year linear power warranty (12-year product warranty)
