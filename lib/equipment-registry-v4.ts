    ...
    requiredAccessories: [
      {
        ...
        description: 'Q-Cable trunk cable — 1 section per AC branch (per-model branch max)',
        required: true, quantityRule: 'formula',
        quantityFormula: 'branches',
        defaultManufacturer: 'Enphase', defaultModel: 'Q Cable 240V',
        defaultPartNumber: 'Q-12-10-240', necReference: 'NEC 690.31',
        notes: '1 trunk cable section per AC branch — branches = ceil(modules / per-model max), IQ8+ 13',
      },
      {
        category: 'terminator',
        description: 'Q-Cable terminator — 1 per AC branch (far end)',
        required: true, quantityRule: 'formula',
        quantityFormula: 'branches',
