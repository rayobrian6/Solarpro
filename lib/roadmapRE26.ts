...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  // ─── v60.x — BLOCKED ON PARTNER TEAMS ────────────────────────────────
  {
    ...
    status: 'blocked',
    effort: 's',
    notes: 'Blocked on the B team (kilby8/site_survey-app). Handoff doc exists: kilby8 commit a503b096 docs/HANDOFF_B_MOBILE_SSO_INTEGRATION.md. Est 2-4 hours of mobile work.',
  ...
  },
  {
    ...
    status: 'blocked',
    effort: 's',
    notes: 'Blocked on the C team (kilby8/site_survey-app backend on Render). Handoff doc exists: kilby8 commit a503b096 docs/HANDOFF_C_RENDER_API_INTEGRATION.md. Est 1-2 hours of backend work.',
    dependsOn: ['v60.5-site-survey-sso-authorize'],
    createdAt: '2026-04-29',
    updatedAt: '2026-04-29',
  },
