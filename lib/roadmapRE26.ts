...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  // ═══ 2026-06 — RECENT WORK (catch-up, all on dev branch) ═══════════════
  {
    ...
    status: 'blocked',
    effort: 'xl',
    notes: 'Met Nearmap (Haley) + EagleView (Tyler) on 2026-06-22; signed the Nearmap $0 eval. Blocked on Nearmap account/API-key access (rep provisioning) + confirming AI Feature API + Roof packs + DSM are on the eval. Validate rural coverage on the test sites (Pocahontas / Granite City IL) first. Plan + Gen-6 roof-field mapping done. See memory: aerial-geometry-nearmap-eagleview.',
