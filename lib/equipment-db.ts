...
export const SOLAR_PANELS: SolarPanel[] = [
  ...
  },
  {
    ...
    manufacturer: 'REC Group',
    model: 'Alpha Pure-R 405W',
    category: 'solar_panel',
    watts: 405, efficiency: 22.3,
    voc: 48.6, vmp: 40.6, isc: 10.60, imp: 9.98,
    tempCoeffVoc: -0.24, tempCoeffIsc: 0.04, tempCoeffPmax: -0.26,
    maxSystemVoltage: 1000, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 44, parallelStringLimit: 3,
    weight: 42.8, length: 68.1, width: 44.0, thickness: 1.18,
    warranty: '25yr product / 25yr power', ulListing: 'UL 61730',
    bifacial: false, cellType: 'HJT',
    // REC Alpha Pure-R (Pure 2) US datasheet — 405W variant of the same family.
    datasheetUrl: 'https://www.recgroup.com/sites/default/files/2025-01/Web_DS%20REC%20Alpha%20Pure%202%20UL_EN%20US%2012122024.pdf',
  },
  // Panasonic
  {
  ...
  // module datasheet before permit submission.
  { id: 'panel-std440', manufacturer: 'Jinko Solar', model: 'Eagle Neo N-type 440W', category: 'solar_panel',
    watts: 440, efficiency: 22.0, voc: 40.2, vmp: 33.7, isc: 13.85, imp: 13.06,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.045, tempCoeffPmax: -0.30, maxSystemVoltage: 1000, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 51.6, length: 69.4, width: 44.5, thickness: 1.18,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://jinkosolar.us', active: true },
  { id: 'panel-jk2', manufacturer: 'Jinko Solar', model: 'Tiger Neo 610W Bifacial', category: 'solar_panel',
    watts: 610, efficiency: 22.6, voc: 53.4, vmp: 44.9, isc: 13.95, imp: 13.59,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.045, tempCoeffPmax: -0.28, maxSystemVoltage: 1500, maxSeriesFuseRating: 25,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 70.5, length: 93.9, width: 44.6, thickness: 1.38,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://jinkosolar.us', active: true },
  { id: 'panel-jk3', manufacturer: 'Jinko Solar', model: 'Tiger Pro 72HC 545W', category: 'solar_panel',
    watts: 545, efficiency: 21.1, voc: 49.6, vmp: 41.5, isc: 13.93, imp: 13.14,
    tempCoeffVoc: -0.28, tempCoeffIsc: 0.048, tempCoeffPmax: -0.35, maxSystemVoltage: 1500, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 69.0, length: 89.7, width: 44.6, thickness: 1.38,
    warranty: '12yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://jinkosolar.us', active: true },
  { id: 'panel-cs2', manufacturer: 'Canadian Solar', model: 'TOPBiHiKu7 620W', category: 'solar_panel',
    watts: 620, efficiency: 22.5, voc: 41.5, vmp: 34.9, isc: 18.55, imp: 17.77,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.048, tempCoeffPmax: -0.29, maxSystemVoltage: 1500, maxSeriesFuseRating: 30,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 71.9, length: 93.9, width: 51.3, thickness: 1.38,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://www.canadiansolar.com', active: true },
  { id: 'panel-cs3', manufacturer: 'Canadian Solar', model: 'HiKu6 Mono 430W', category: 'solar_panel',
    watts: 430, efficiency: 21.9, voc: 39.7, vmp: 33.1, isc: 13.87, imp: 13.00,
    tempCoeffVoc: -0.26, tempCoeffIsc: 0.05, tempCoeffPmax: -0.35, maxSystemVoltage: 1500, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 52.9, length: 74.0, width: 41.3, thickness: 1.18,
    warranty: '12yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://www.canadiansolar.com', active: true },
  { id: 'panel-lo2', manufacturer: 'LONGi Solar', model: 'Hi-MO X6 Pro 615W', category: 'solar_panel',
    watts: 615, efficiency: 22.8, voc: 40.9, vmp: 34.8, isc: 18.60, imp: 17.68,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.048, tempCoeffPmax: -0.28, maxSystemVoltage: 1500, maxSeriesFuseRating: 30,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 70.5, length: 93.9, width: 44.6, thickness: 1.38,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'HJT',
    datasheetUrl: 'https://www.longi.com', active: true },
  { id: 'panel-tr2', manufacturer: 'Trina Solar', model: 'Vertex 600W Bifacial', category: 'solar_panel',
    watts: 600, efficiency: 21.9, voc: 41.4, vmp: 34.6, isc: 18.55, imp: 17.35,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.048, tempCoeffPmax: -0.29, maxSystemVoltage: 1500, maxSeriesFuseRating: 30,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 71.9, length: 93.9, width: 51.3, thickness: 1.38,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://www.trinasolar.com', active: true },
  { id: 'panel-qc2', manufacturer: 'Q CELLS', model: 'Q.TRON BFR-G2+ 430W', category: 'solar_panel',
    watts: 430, efficiency: 21.9, voc: 38.7, vmp: 32.5, isc: 14.00, imp: 13.24,
    tempCoeffVoc: -0.24, tempCoeffIsc: 0.04, tempCoeffPmax: -0.29, maxSystemVoltage: 1500, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 52.9, length: 74.0, width: 41.3, thickness: 1.26,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://www.qcells.com', active: true },
  { id: 'panel-ax1', manufacturer: 'Axitec', model: 'AXIblackpremium X HC 420W', category: 'solar_panel',
    watts: 420, efficiency: 22.8, voc: 37.9, vmp: 31.8, isc: 13.95, imp: 13.22,
    tempCoeffVoc: -0.27, tempCoeffIsc: 0.05, tempCoeffPmax: -0.30, maxSystemVoltage: 1000, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 48.5, length: 69.4, width: 41.3, thickness: 1.18,
    warranty: '15yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://www.axitecsolar.com', active: true },
  { id: 'panel-hq1', manufacturer: 'Hanwha Q CELLS', model: 'Q.PEAK DUO XL-G11 500W', category: 'solar_panel',
    watts: 500, efficiency: 21.1, voc: 45.5, vmp: 38.2, isc: 13.90, imp: 13.09,
    tempCoeffVoc: -0.27, tempCoeffIsc: 0.04, tempCoeffPmax: -0.34, maxSystemVoltage: 1500, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 63.9, length: 82.4, width: 44.6, thickness: 1.38,
    warranty: '25yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://www.qcells.com', active: true },
  { id: 'panel-sol1', manufacturer: 'Solaria', model: 'PowerXT-400R-PM', category: 'solar_panel',
    watts: 400, efficiency: 22.6, voc: 48.2, vmp: 40.6, isc: 10.50, imp: 9.86,
    tempCoeffVoc: -0.27, tempCoeffIsc: 0.04, tempCoeffPmax: -0.29, maxSystemVoltage: 1000, maxSeriesFuseRating: 15,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 46.3, length: 68.5, width: 40.0, thickness: 1.57,
    warranty: '25yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://www.solaria.com', active: true },
  { id: 'panel-ms1', manufacturer: 'Mission Solar', model: 'MSE PERC 72 400W', category: 'solar_panel',
    watts: 400, efficiency: 21.5, voc: 49.0, vmp: 40.5, isc: 10.40, imp: 9.88,
    tempCoeffVoc: -0.29, tempCoeffIsc: 0.05, tempCoeffPmax: -0.37, maxSystemVoltage: 1000, maxSeriesFuseRating: 15,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 51.8, length: 68.5, width: 40.3, thickness: 1.57,
    warranty: '25yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://missionsolar.com', active: true },
  { id: 'panel-bv1', manufacturer: 'Boviet Solar', model: 'BVM6612M-420W', category: 'solar_panel',
    watts: 420, efficiency: 21.4, voc: 49.5, vmp: 41.2, isc: 10.70, imp: 10.20,
    tempCoeffVoc: -0.27, tempCoeffIsc: 0.05, tempCoeffPmax: -0.35, maxSystemVoltage: 1000, maxSeriesFuseRating: 15,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 52.9, length: 69.4, width: 41.3, thickness: 1.38,
    warranty: '12yr product / 25yr power', ulListing: 'UL 61730', bifacial: false, cellType: 'mono-PERC',
    datasheetUrl: 'https://bovietsolar.com', active: true },
  { id: 'panel-as1', manufacturer: 'Astronergy', model: 'CHSM72M(BL)-HC 580W', category: 'solar_panel',
    watts: 580, efficiency: 22.4, voc: 51.8, vmp: 43.4, isc: 13.95, imp: 13.36,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.045, tempCoeffPmax: -0.30, maxSystemVoltage: 1500, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 2, weight: 69.0, length: 89.7, width: 44.6, thickness: 1.38,
    warranty: '15yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://www.astronergy.com', active: true },
  { id: 'panel-fence1', manufacturer: 'Jinko Solar', model: 'Tiger Neo Bifacial 400W (Fence)', category: 'solar_panel',
    watts: 400, efficiency: 22.0, voc: 37.2, vmp: 30.9, isc: 13.73, imp: 12.95,
    tempCoeffVoc: -0.25, tempCoeffIsc: 0.045, tempCoeffPmax: -0.28, maxSystemVoltage: 1000, maxSeriesFuseRating: 20,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 47.4, length: 66.5, width: 41.2, thickness: 1.18,
    warranty: '25yr product / 30yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'N-type TOPCon',
    datasheetUrl: 'https://jinkosolar.us', active: true },
  { id: 'panel-fence2', manufacturer: 'Canadian Solar', model: 'BiKu CS3W-440PB (Fence)', category: 'solar_panel',
    watts: 440, efficiency: 22.2, voc: 48.4, vmp: 40.2, isc: 11.55, imp: 10.95,
    tempCoeffVoc: -0.26, tempCoeffIsc: 0.05, tempCoeffPmax: -0.34, maxSystemVoltage: 1500, maxSeriesFuseRating: 15,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 55.1, length: 74.0, width: 41.3, thickness: 1.18,
    warranty: '12yr product / 25yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'mono-PERC',
    datasheetUrl: 'https://www.canadiansolar.com', active: true },
  { id: 'panel-fence3', manufacturer: 'LONGi Solar', model: 'Hi-MO 5m 420W Bifacial (Fence)', category: 'solar_panel',
    watts: 420, efficiency: 21.3, voc: 49.5, vmp: 41.4, isc: 10.75, imp: 10.15,
    tempCoeffVoc: -0.26, tempCoeffIsc: 0.05, tempCoeffPmax: -0.30, maxSystemVoltage: 1500, maxSeriesFuseRating: 15,
    nominalOperatingTemp: 45, parallelStringLimit: 3, weight: 52.9, length: 69.4, width: 41.3, thickness: 1.18,
    warranty: '12yr product / 25yr power', ulListing: 'UL 61730', bifacial: true, cellType: 'mono-PERC',
    datasheetUrl: 'https://www.longi.com', active: true },
];
...
export const BATTERIES: BatterySystem[] = [
  ...
  // ── Curated Design-Studio batteries, unified into the single source (ids match
  // lib/db.ts). Representative datasheet values — FIELD VERIFY before permit. ──
  { id: 'bat-fr1', manufacturer: 'Franklin Electric', model: 'aGate 13.6kWh', category: 'battery', subcategory: 'ac_coupled',
    usableCapacityKwh: 13.6, peakPowerKw: 20.0, continuousPowerKw: 10.0, roundTripEfficiencyPct: 96.0, chemistry: 'LFP', voltageNominalV: 51.2,
    acOutputVoltageV: 240, maxContinuousOutputA: 42, backfeedBreakerA: 60, minDedicatedBreakerA: 60,
    weightLbs: 125, outdoorRated: true, ipRating: 'NEMA 3R', gridFormingCapable: true, backupCapable: true, wholeHomeBackup: true, requiresGateway: false,
    warrantyYears: 12, cycleGuarantee: '6000 cycles', capacityRetentionPct: 70, ulListing: 'UL 9540 / UL 9540A', msrpUsd: 10800, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.franklinwh.com' },
  { id: 'bat-se1', manufacturer: 'SolarEdge', model: 'Home Battery 9.7kWh', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 9.7, peakPowerKw: 7.5, continuousPowerKw: 5.0, roundTripEfficiencyPct: 94.5, chemistry: 'LFP', voltageNominalV: 400,
    weightLbs: 100, outdoorRated: true, ipRating: 'IP55', gridFormingCapable: true, backupCapable: true, wholeHomeBackup: false, requiresGateway: true, gatewayModel: 'SolarEdge Home Hub Inverter',
    warrantyYears: 10, cycleGuarantee: '10yr / >70% retention', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 8200, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.solaredge.com' },
  { id: 'bat-gen1', manufacturer: 'Generac', model: 'PWRcell M6 (9kWh)', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 9.0, peakPowerKw: 9.0, continuousPowerKw: 4.5, roundTripEfficiencyPct: 96.5, chemistry: 'LFP', voltageNominalV: 400,
    weightLbs: 95, outdoorRated: false, ipRating: 'NEMA 1', gridFormingCapable: true, backupCapable: true, wholeHomeBackup: false, requiresGateway: true, gatewayModel: 'Generac PWRcell Inverter',
    warrantyYears: 10, cycleGuarantee: '7500 cycles', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 9500, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.generac.com' },
  { id: 'bat-gen2', manufacturer: 'Generac', model: 'PWRcell M3 (4.5kWh)', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 4.5, peakPowerKw: 9.0, continuousPowerKw: 4.5, roundTripEfficiencyPct: 96.5, chemistry: 'LFP', voltageNominalV: 400,
    weightLbs: 55, outdoorRated: false, ipRating: 'NEMA 1', gridFormingCapable: true, backupCapable: true, wholeHomeBackup: false, requiresGateway: true, gatewayModel: 'Generac PWRcell Inverter',
    warrantyYears: 10, cycleGuarantee: '7500 cycles', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 5200, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.generac.com' },
  { id: 'bat-lg1', manufacturer: 'LG Energy Solution', model: 'RESU16H Prime', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 16.0, peakPowerKw: 11.0, continuousPowerKw: 7.0, roundTripEfficiencyPct: 95.0, chemistry: 'NMC', voltageNominalV: 400,
    weightLbs: 135, outdoorRated: true, ipRating: 'IP55', gridFormingCapable: false, backupCapable: true, wholeHomeBackup: false, requiresGateway: true, gatewayModel: 'compatible HV hybrid inverter',
    warrantyYears: 10, cycleGuarantee: '10yr / >70% retention', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 12500, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.lgessbattery.com' },
  { id: 'bat-lg2', manufacturer: 'LG Energy Solution', model: 'RESU10H Prime', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 9.6, peakPowerKw: 7.0, continuousPowerKw: 5.0, roundTripEfficiencyPct: 95.0, chemistry: 'NMC', voltageNominalV: 400,
    weightLbs: 97, outdoorRated: true, ipRating: 'IP55', gridFormingCapable: false, backupCapable: true, wholeHomeBackup: false, requiresGateway: true, gatewayModel: 'compatible HV hybrid inverter',
    warrantyYears: 10, cycleGuarantee: '10yr / >70% retention', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 8800, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.lgessbattery.com' },
  { id: 'bat-son1', manufacturer: 'Sonnen', model: 'sonnenCore+ 10kWh', category: 'battery', subcategory: 'ac_coupled',
    usableCapacityKwh: 10.0, peakPowerKw: 8.0, continuousPowerKw: 4.8, roundTripEfficiencyPct: 85.0, chemistry: 'LFP', voltageNominalV: 51.2,
    acOutputVoltageV: 240, maxContinuousOutputA: 20, backfeedBreakerA: 30, minDedicatedBreakerA: 30,
    weightLbs: 113, outdoorRated: false, ipRating: 'NEMA 1', gridFormingCapable: true, backupCapable: true, wholeHomeBackup: false, requiresGateway: false,
    warrantyYears: 10, cycleGuarantee: '10000 cycles', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 11000, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://sonnenusa.com' },
  { id: 'bat-sg1', manufacturer: 'Sungrow', model: 'SBR096 9.6kWh', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 9.6, peakPowerKw: 8.0, continuousPowerKw: 5.0, roundTripEfficiencyPct: 96.0, chemistry: 'LFP', voltageNominalV: 400,
    weightLbs: 92, outdoorRated: true, ipRating: 'IP55', gridFormingCapable: false, backupCapable: true, wholeHomeBackup: false, requiresGateway: true, gatewayModel: 'Sungrow SH hybrid inverter',
    warrantyYears: 10, cycleGuarantee: '6000 cycles', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 7500, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.sungrowpower.com' },
  { id: 'bat-fp1', manufacturer: 'Fortress Power', model: 'eVault Max 18.5kWh', category: 'battery', subcategory: 'dc_coupled',
    usableCapacityKwh: 18.5, peakPowerKw: 14.4, continuousPowerKw: 9.6, roundTripEfficiencyPct: 98.0, chemistry: 'LFP', voltageNominalV: 51.2,
    weightLbs: 175, outdoorRated: false, ipRating: 'NEMA 1', gridFormingCapable: false, backupCapable: true, wholeHomeBackup: true, requiresGateway: true, gatewayModel: 'compatible 48V hybrid inverter',
    warrantyYears: 10, cycleGuarantee: '6000 cycles', capacityRetentionPct: 80, ulListing: 'UL 9540', msrpUsd: 14500, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.fortresspower.com' },
  { id: 'bat-dur1', manufacturer: 'Duracell Energy', model: 'PowerBank 10kWh', category: 'battery', subcategory: 'ac_coupled',
    usableCapacityKwh: 10.0, peakPowerKw: 8.0, continuousPowerKw: 5.0, roundTripEfficiencyPct: 95.0, chemistry: 'LFP', voltageNominalV: 51.2,
    acOutputVoltageV: 240, maxContinuousOutputA: 21, backfeedBreakerA: 30, minDedicatedBreakerA: 30,
    weightLbs: 98, outdoorRated: true, ipRating: 'IP55', gridFormingCapable: true, backupCapable: true, wholeHomeBackup: false, requiresGateway: false,
    warrantyYears: 10, cycleGuarantee: '6000 cycles', capacityRetentionPct: 70, ulListing: 'UL 9540', msrpUsd: 8900, necRefs: ['NEC 706 — Energy Storage Systems', 'NEC 705.12(B) — battery backfeed adds to bus loading'], certifications: ['UL 9540', 'UL 9540A', 'IEEE 1547'], active: true, datasheetUrl: 'https://www.duracellenergy.com' },
];
