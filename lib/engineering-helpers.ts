...
export const ROOF_TYPES: Record<RoofType, { label: string; attachment: string; hardware: string; notes: string }> = {
  shingle:             { label: 'Asphalt Shingle',             attachment: 'Flashed roof attachment base with lag into rafter',           hardware: 'Rail + roof-attachment base per selected RackingAssembly (rail PENDING SELECTION \u2014 do not assume a brand); flashed 5/16" \u00d7 3" lag into rafter, EPDM/flashed penetration', notes: 'Locate rafters with stud finder. Min. 2.5" embedment into rafter. Flash all penetrations.' },
