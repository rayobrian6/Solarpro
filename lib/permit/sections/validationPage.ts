  ...
  <div class="page">
    ...
    <div class="page-content">
      ...
      <table class="equip-table" style="width:100%;">
        ...
        <tbody>
          ...
          <tr style="background:${i%2===0?'#fff':'#f9f9f9'};">
            ...
            <td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;color:#000;">${c.value}</td>
      ...
      <table class="equip-table" style="width:100%;">
        ...
        <tbody>
          <tr>
            ...
            <td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;color:#000;">${esc(surveyEvidenceSummary)}</td>
          ...
          <tr style="background:#f9f9f9;">
            ...
            <td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;color:#000;">${esc(surveyPhotoCategoryRows)}</td>
          ...
          <tr>
            ...
            <td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;color:${surveyEvidence?.missingCategories.length ? '#b45309' : '#006600'};">${esc(missingSurveyEvidence)}</td>
          ...
          <tr style="background:${i%2===0?'#f9f9f9':'#fff'};">
            ...
            <td colspan="3" style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;color:#000;">${esc(value)}</td>
          </tr>`).join('')}
          ...
          <tr style="background:${i%2===0?'#faf5ff':'#fff'};">
            <td style="font-weight:600;font-size:7.5px;">${esc(label)}</td>
            <td colspan="3" style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:6.5px;color:#000;">${esc(value)}</td>
          </tr>`).join('')}
          ...
          <tr style="background:${i%2===0?'#fff1f2':'#fff'};">
            <td style="font-weight:600;font-size:7.5px;">${esc(label)}</td>
            <td colspan="3" style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:6.25px;color:#000;">${esc(value)}</td>
          </tr>`).join('')}
        ...
        <tr style="background:${i%2===0?'#ecfdf5':'#fff'};">
          <td style="font-weight:600;font-size:7.5px;">${esc(label)}</td>
          <td colspan="3" style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:6px;color:#000;">${esc(value)}</td>
        </tr>`).join('')}
      ...
      <table class="equip-table" style="width:100%;">
        ...
        <tbody>
          <tr><td>Velocity Pressure</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">qz = 0.00256 × Kz × Kzt × Kd × V²</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">Kz=0.85, Kzt=1.0, Kd=0.85, V=${canonical.site.windSpeed} mph</td><td style="font-weight:bold;">${qzDisp}</td></tr>
          <tr style="background:#f9f9f9"><td>Net Wind Pressure</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">p = qz × Cf</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">Cf=1.3 (solid panel, Fig. 29.4-1)</td><td style="font-weight:bold;">${windPressDisp}</td></tr>
          <tr><td>Lateral Force / Post</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">F = p × H × S</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">H=${canonical.structure.panelHeightFt.toFixed(2)} ft, S=${canonical.structure.postSpacingFt.toFixed(1)} ft</td><td style="font-weight:bold;">${windForce}</td></tr>
          <tr style="background:#f9f9f9"><td>Overturning Moment</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">M = F × H/2</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">H/2 = ${(canonical.structure.panelHeightFt/2).toFixed(2)} ft</td><td style="font-weight:bold;">${windMoment}</td></tr>
          <tr><td>Required Embedment</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">D = 1.5 × ∛(M / (q × b))</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">q=${canonical.structure.soilResistance} psf, b=0.25 ft</td><td style="font-weight:bold;">${reqEmbed}</td></tr>
          <tr style="background:#f9f9f9"><td>Provided Embedment</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">D_prov (CAD-sourced)</td><td style="font-family:"SolarPro Mono","SolarPro Symbols";font-size:7px;">${canonical.structure.postEmbedFt.toFixed(1)} ft min.</td><td style="font-weight:bold;color:${embedColor};">${provEmbed} — ${embedStatus}</td></tr>
        </tbody>
      </table>` : ''}
