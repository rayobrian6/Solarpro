...
// STATE NEC ADOPTION MAP — updated for NEC 2023 rollout (v48.x)
// Sources: NFPA state adoption tracker + ICC state adoption portal (verified 2025-Q1)
// States confirmed on NEC 2023: CA, NY, MA, TX, OR, VA, MD, NJ, CT, RI,
//   WA (adopted 2024), FL (adopted 2024), CO (AHJ-dependent, statewide 2024),
//   NC (2024 NC Electrical Code = NEC 2023 base), PA (Act 45 → 2023 effective 2025)
// States still on NEC 2020: AZ, NV, NM, UT, SC, GA, VT, NH, ME (as of Q1 2025)
const STATE_NEC_DEFAULTS: Record<string, string> = {
  // NEC 2023 states
  CA: '2023', NY: '2023', MA: '2023', TX: '2023', OR: '2023',
  VA: '2023', MD: '2023', NJ: '2023', CT: '2023', RI: '2023',
  WA: '2023', FL: '2023', CO: '2023', NC: '2023', PA: '2023',
  // NEC 2020 states
  AZ: '2020', NV: '2020', NM: '2020', UT: '2020', SC: '2020',
  GA: '2020', VT: '2020', NH: '2020', ME: '2020',
};

// DEFAULT NEC 2020 FOR UNMAPPED STATES (conservative — AHJ must confirm)
