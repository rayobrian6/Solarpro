// ─────────────────────────────────────────────────────────────────────────────
// UPSTREAM_ESTIMATOR — v47.253
// This file is an UPSTREAM ESTIMATING TOOL only.
// It is used for quick project-creation estimates (cost/payback preview).
// It is NOT part of the canonical proposal pipeline.
// Canonical proposal financials derive from:
//   EnergyFlow → computeEnergyValue() → calculate25yrProjection() → buildCanonicalProposal()
// production * retail_rate shortcuts here are INTENTIONAL for speed estimates only.
// DO NOT use pricingEngine outputs in proposal view or canonical pipeline.
// ─────────────────────────────────────────────────────────────────────────────
// ============================================================
