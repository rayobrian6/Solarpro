-- Migration 068: repair missing canonical contractor_profiles table
-- Idempotent copy of migration 044 for shared DBs that missed the original contractor profile migration.
