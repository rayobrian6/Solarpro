-- Migration 063: repair missing canonical opportunity_screening_queue table
-- Idempotent copy of migration 049 for shared DBs that missed the original screening migration.
