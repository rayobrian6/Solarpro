-- Migration 069: repair missing canonical opportunity_sources table
-- Idempotent copy of migration 048 for shared DBs that missed the original attribution migration.
