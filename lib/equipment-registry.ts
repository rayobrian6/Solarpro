...
export const EQUIPMENT_REGISTRY: EquipmentRegistryEntry[] = [
...

  {
    ...
    requiredAccessories: [
      ...
      },
      {
        ...
        defaultPartNumber: '481-00252-32',
...

  {
    ...
    requiredAccessories: [
      ...
      {
        category: 'ac_disconnect',
        description: 'AC disconnect per NEC 690.13',
        required: true,
        quantityRule: 'perSystem',
        defaultManufacturer: 'Square D',
        defaultModel: 'AC Disconnect Switch',
  ...
  // ── PHASE 4: Roof Tech Mini (Rail-Based Standoff) ──────────────────────────────
  // Assembly: RT-MINI flashed pad (2 lag bolts into rafter) → L-foot → standard rail
  {
    id: 'rooftech-mini',
    ...
    requiredAccessories: [
      {
        category: 'attachment',
        description: 'RT-MINI flashed pad — 1 per rafter attachment point',
        required: true,
        quantityRule: 'perAttachment',
        defaultManufacturer: 'Roof Tech',
        defaultModel: 'RT-MINI Pad Assembly',
      ...
      },
      {
        ...
        defaultModel: '5/16" × 3" Lag Bolt SS',
        defaultPartNumber: 'LAG-516-3-SS',
        necReference: 'ASCE 7-22 / ICC-ES ESR-3575',
        notes: 'Stainless steel, min 2.5" embedment into rafter',
      },
      {
        category: 'l_foot',
        description: 'L-foot — 1 per RT-MINI pad (mounts to pad stud, receives rail)',
        required: true,
        quantityRule: 'perAttachment',
        defaultManufacturer: 'IronRidge',
        defaultModel: 'L-Foot Universal',
        defaultPartNumber: 'LFT-001-B',
        necReference: 'ASCE 7-22',
        notes: 'Compatible with IronRidge, Pegasus, UniRac, and most standard rails',
      },
      {
        category: 'rail',
